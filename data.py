...
THIRTEEN = boardData("thirteen", (870, 200, 1050, 820), (760, 970), 1.75, blurshape=(6,2), minspread=10, squares=True)

FOURTEEN = boardData("fourteen", (870, 200, 1050, 820), (760, 970), 1.75, blurshape=(6,2), minspread=10, edgeHexes=True)

#COLDRAW = boardData("coldraw", (855, 220, 1060, 860), (760, 970), 1.65, blurshape=(1,1), linethresh=400, minspread=2)
COLDRAW = boardData("coldraw", (870, 200, 1050, 820), (760, 970), 1.75, blurshape=(1,1), linethresh=400, minspread=2)
